...
- Mind [repository](https://github.com/aliyilmaz/Mind/archive/master.zip)
- Project [repository](https://github.com/aliyilmaz/project/archive/master.zip)

---------- 

## Database Settings

To use the class, it is necessary to define database information in the **Mind.php** file or when calling the class.
